package com.munifahsan.bioshedistributor.ui.daftarOrderMenunggu
...
import com.munifahsan.bioshedistributor.databinding.FragmentDaftarOrderMenungguBinding
...
class DaftarOrderMenungguFragment : Fragment() {

    private var _binding: FragmentDaftarOrderMenungguBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDaftarOrderMenungguBinding.inflate(layoutInflater, container,false)
...
//            statusTxt.text = status
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            DaftarOrderMenungguFragment().apply {
