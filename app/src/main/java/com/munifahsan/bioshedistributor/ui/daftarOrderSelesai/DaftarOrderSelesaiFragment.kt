package com.munifahsan.bioshedistributor.ui.daftarOrderSelesai
...
import com.munifahsan.bioshedistributor.databinding.FragmentDaftarOrderDiprosesBinding
...
class DaftarOrderSelesaiFragment : Fragment() {

    private var _binding: FragmentDaftarOrderSelesaiBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDaftarOrderSelesaiBinding.inflate(layoutInflater, container, false)
    ...
    private fun showTransaksi() {
        ...
        val query = rootRef.collection("ORDERS")
            ...
            .whereEqualTo( "selesaiDiterima", true)
...
//            statusTxt.text = status
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            DaftarOrderSelesaiFragment().apply {
