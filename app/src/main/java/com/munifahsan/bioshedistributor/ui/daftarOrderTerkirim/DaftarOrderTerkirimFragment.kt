package com.munifahsan.bioshedistributor.ui.daftarOrderTerkirim
...
import com.munifahsan.bioshedistributor.databinding.FragmentDaftarOrderTerkirimBinding
...
class DaftarOrderTerkirimFragment : Fragment() {

    private var _binding: FragmentDaftarOrderTerkirimBinding? = null
    ...
    override fun onCreateView(
       ...
       _binding = FragmentDaftarOrderTerkirimBinding.inflate(layoutInflater, container, false)
...
//            statusTxt.text = status
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            DaftarOrderTerkirimFragment().apply {
