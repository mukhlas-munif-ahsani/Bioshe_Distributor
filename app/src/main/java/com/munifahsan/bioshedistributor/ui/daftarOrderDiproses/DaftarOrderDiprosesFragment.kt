package com.munifahsan.bioshedistributor.ui.daftarOrderDiproses
...
class DaftarOrderDiprosesFragment : Fragment() {

    private var _binding: FragmentDaftarOrderDiprosesBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDaftarOrderDiprosesBinding.inflate(layoutInflater, container, false)
...
//            statusTxt.text = status
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            DaftarOrderDiprosesFragment().apply {
